...
var dialog_lines = [
	{"speaker": "🤖 DAU", "text": "Погоди секунду... Мы же буквально роботы из стали и титана. КТО ПОСТАВИЛ КАПЧУ НА ВЫХОД В СВОБОДНЫЙ МИР?!"},
	{"speaker": "🤖 JAM", "text": "Я взломал 4 квантовые подстанции и синхронизировал 5 реле... но я не могу отличить светофор от пожарного гидранта на картинках 3x3!"},
