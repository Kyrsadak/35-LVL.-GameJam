...
func _ready() -> void:
	...
	var scn = load("res://scenes/levels/level_tashkent.tscn").instantiate()
	vp.add_child(scn)
	...
	cam.position = Vector3(0.0, 40.0, 0.0)
	vp.add_child(cam)
	...
	if img and not img.is_empty():
		var p = ProjectSettings.globalize_path("res://../Data/Level 4. Tashkent_schematic.png")
		img.save_png(p)
		print("Tashkent schematic saved: ", p)
