...
func _ready() -> void:
	...
	var scn = load("res://scenes/levels/level_samarkand.tscn").instantiate()
	vp.add_child(scn)
	...
	cam.position = Vector3(-2.0, 40.0, 0.0)
	vp.add_child(cam)
	...
	if img and not img.is_empty():
		var p = ProjectSettings.globalize_path("res://../Data/Level 3. Samarkand_schematic.png")
		img.save_png(p)
		print("Samarkand schematic saved: ", p)
